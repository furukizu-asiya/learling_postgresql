create table locations (LOCATION_ID NUMERIC, STREET_ADDRESS VARCHAR(50), city VARCHAR(20), country_id VARCHAR(2));
...
create table employees (EMPLOYEE_ID NUMERIC, FIRST_NAME VARCHAR(20)
...
Create table departments (department_id NUMERIC, DEPARTMENT_NAME VARCHAR(20), MANAGER_ID NUMERIC, LOCATION_ID NUMERIC);
